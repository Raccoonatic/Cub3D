...
## 🎮 Description
An homage to the legendary Wolfenstein 3D. Cub3D is a project that explores the mathematical foundations of early 3D gaming to create a first-person raycasting engine completely in C.
